...
class HrEmployee(models.Model):
    ...
    state = fields.Selection(string="Employee State", selection=[('active', 'Active'),('suspended', 'Suspended'), ('terminated', 'Terminated'),('resigned','Resigned')],default='active', required=False, )
    ...
    def retirement_notification(self):
        ...
        users = self.env.ref('eltarek_hr_end_service.group_end_of_service_notifications').users
        ...
        for emp in employees:
            notification_temp = self.env.ref('eltarek_hr_end_service.mail_template_end_of_service')
